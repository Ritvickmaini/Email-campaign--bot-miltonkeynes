...
SMTP_PORT = 587
SENDER_EMAIL = "mikee@miltonkeynesexpo.com"
...
def send_email(recipient, first_name, subject, html_body):
    ...
    encoded_event_url = urllib.parse.quote_plus(
        "https://MiltonKeynesExpo26VisitorsTicket.eventbrite.co.uk"
    )
    ...
    <div style="color:#000;font-weight:bold;">
        ...
        <a href="mailto:mikee@miltonkeynesexpo.com" style="color:#000;text-decoration:none;">mikee@miltonkeynesexpo.com</a><br>
    </div>"""
